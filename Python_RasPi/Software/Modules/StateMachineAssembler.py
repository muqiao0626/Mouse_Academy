...
'''
import os, sys
sys.path.append("Bpod_Gen2-new/Python 3/Modules") # Add Bpod system files to Python path
import struct
import math
class stateMachine(object):
    def __init__(self, bpodObject):
        ...
        self.metaOutputNames = ('Valve', 'LED', 'SoftCode')
        self.stateNames = []
                ...
                for i in range(0,nactions,2):
                    ...
                    if thisAction in self.metaOutputNames:
                        ...
                        if metaAction == 0: # Valve
                            ...
                            thisOutputValue = 255;
                        elif metaAction == 2: # SoftCode
                            thisOutputCode = self.outputChannelNames.index('SoftCode')
                            thisOutputValue = value;
                        else:
